...
function Reminders() {
  ...
  const markNotificationsSeen = async () => {
    try {
      const response = await fetch("https://myhome-os-backend.vercel.app/api/notifications/read", {
        method: "PUT",
    ...
    const loadReminders = async () => {
      try {
        const response = await fetch(
          `https://myhome-os-backend.vercel.app/api/reminders?user_id=${userId}`
        );
  ...
  useEffect(() => {
    ...
    const loadNotifications = async () => {
      try {
        const response = await fetch(
          `https://myhome-os-backend.vercel.app/api/notifications?user_id=${userId}`
        );
  ...
  const completeReminder = async (id) => {
    ...
    try {
      const response = await fetch(`https://myhome-os-backend.vercel.app/api/reminders/${id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  const handleAddReminder = async (event) => {
    ...
    try {
      const response = await fetch("https://myhome-os-backend.vercel.app/api/reminders", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  const handleEditReminder = async (event) => {
    ...
    try {
      const response = await fetch(`https://myhome-os-backend.vercel.app/api/reminders/${editReminder.id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
  ...
  const handleDeleteReminder = async () => {
    ...
    try {
      const response = await fetch(
        `https://myhome-os-backend.vercel.app/api/reminders/${deleteReminder.id}?user_id=${userId}`,
        { method: "DELETE" }
      );
      const data = await response.json();
      if (!response.ok || !data.success) throw new Error(data.message);
